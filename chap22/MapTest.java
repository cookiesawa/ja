...
public class MapTest {
	public static void main(String args[]) {
		Map<String, Student> st = new HashMap<String, Student>(); // Map객체 생성, HashMap 사용
		...
		st.put("20090003", new Student(20090003, "소이정")); // 하나의 항목을 대치
		System.out.println(st.get("20090003")); // 모든 항목 방문
